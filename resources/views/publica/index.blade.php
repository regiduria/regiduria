...
<div class="d-grid gap-2">
    ...
    <center><p class="h1" >COMERCIO EN VIA PUBLICA</p></center>

    <form action="{{route('tramites.create')}}" method="">
        <button type="submit" name="nuevo" value="COMERCIO" class="btn btn-outline-success btn-lg" >NUEVO</button>
    </form>
...
<script>
    ...
    $('.eliminar-tramite').submit(function (e){
        ...
        Swal.fire({
  title: '¿ESTAS SEGURO?',
  text: "ESTE TRAMITE SE ELIMINARA DE COMERCIO EN VIA PUBLICA",
  icon: 'warning',
