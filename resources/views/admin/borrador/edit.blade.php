...
<div class="input-group input-group mb-3">
    <label for="exampleFormControlInput1" class="input-group-text">
        ...
        <div class="input-group input-group mb-3">
            <label for="exampleFormControlInput1" class="input-group-text">
             CLAVE DEL LICENCIADO QUE LLEVA EL TRAMITE:</label>
    ...
    <button type="submit" class="btn btn-outline-primary" class="btn btn-primary btn-sm" id="boton" name="enviar2" value="{{$tramite->id}}">AGREGAR</button>
</form>
