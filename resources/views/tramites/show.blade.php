...
<div class="input-group input-group mb-3">
    <label for="exampleFormControlInput1" class="input-group-text"> CLAVE: </label>
            <input type="text" name ='clave' class="form-control" readonly="readonly" aria-label="Username" onkeyup="javascript:this.value=this.value.toUpperCase();" aria-describedby="basic-addon1"  value="{{$tramite->clave}}">
</div>
    <div class="input-group input-group mb-3">
...
<div class="input-group input-group mb-3">
    <label for="exampleFormControlInput1" class="input-group-text"> LIC DIRIGE: </label>
            <input type="text" name ='area' class="form-control" readonly="readonly" aria-label="Username" onkeyup="javascript:this.value=this.value.toUpperCase();" aria-describedby="basic-addon1"  value="{{$tramite->lic_dirige}}">
</div>
<div class="input-group input-group mb-3">
...
<div class="input-group input-group mb-3">
    <label for="exampleFormControlInput1" class="input-group-text"> NUMERO DE CONTROL DE LA CARPETA</label>
            <input type="text" name ='area' class="form-control" readonly="readonly" aria-label="Username" onkeyup="javascript:this.value=this.value.toUpperCase();" aria-describedby="basic-addon1"  value="{{$tramite->nc_carpeta}}">
</div>
<div class="input-group input-group mb-3">
