...
<div class="d-grid gap-2">
    ...
    <center><p class="h1" >BIENES</p></center>

    <form action="{{route('tramites.create')}}" method="">
        <button type="submit" name="nuevo" value="BIENES" class="btn btn-outline-success btn-lg" >nuevo</button>
    </form>
...
<script>
    ...
    $('.eliminar-tramite').submit(function (e){
        ...
        Swal.fire({
  title: '¿ESTAS SEGURO?',
  text: "ESTE TRAMITE SE ELIMINARA DE BIENES",
  icon: 'warning',
